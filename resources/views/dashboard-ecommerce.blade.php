            ...
            <div class="card browser-statistics-box mb-30">
                ...
                <div class="card-body">
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/chrome.png') }}" alt="image">
                        </div>
                    ...
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/mozilla.png') }}" alt="image">
                        </div>
                    ...
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/opera.png') }}" alt="image">
                        </div>
                    ...
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/edge.png') }}" alt="image">
                        </div>
                    ...
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/internet-explore.png') }}" alt="image">
                        </div>
                    ...
                    <div class="box d-flex align-items-center">
                        <div class="img">
                            <img src="{{ asset('assets/img/brave.png') }}" alt="image">
                        </div>
            ...
            <div class="card mb-30 greetings-card-box">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="image">
                            <img src="{{ asset('assets/img/trophy.png') }}" width="400" height="400" alt="image">
                        </div>
                        <div class="content">
                            <div class="icon mb-3">
            ...
            <div class="card mb-30 social-marketing-box">
                ...
                <div class="card-body">
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">Facebook Ads</a>
                        </h4>
                    ...
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">Twitter Ads</a>
                        </h4>
                    ...
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">Instagram Ads</a>
                        </h4>
                    ...
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">Linkedin Ads</a>
                        </h4>
                        <p class="mb-0">5.5k Sale - 5.2k Like</p>
                        <div class="stats">
                            <i class='bx bx-trending-up text-success'></i>
                    ...
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">Youtube Ads</a>
                        </h4>
                        <p class="mb-0">5.3k Sale - 4.9k Like</p>
                        <div class="stats">
                            <i class='bx bx-trending-up text-success'></i>
                    ...
                    <div class="list">
                        ...
                        <h4 class="mb-1">
                            <a href="#" class="d-inline-block">GitHub Ads</a>
                        </h4>
                        <p class="mb-0">5.1k Sale - 4.6k Like</p>
                        <div class="stats">
                            <i class='bx bx-trending-down text-danger'></i>
                    ...
                    <ul>
                        <li class="single-product">
                            <a href="#" class="image d-inline-block">
                                <img src="{{ asset('assets/img/product1.jpg') }}" alt="image">
                            </a>
                            ...
                            <a href="#" class="view-link d-inline-block" data-toggle="tooltip" data-placement="top" title="View Details">
                        ...
                        <li class="single-product">
                            <a href="#" class="image d-inline-block">
                                <img src="{{ asset('assets/img/product2.jpg') }}" alt="image">
                            </a>
                        ...
                        <li class="single-product">
                            <a href="#" class="image d-inline-block">
                                <img src="{{ asset('assets/img/product3.jpg') }}" alt="image">
                            </a>
                        ...
                        <li class="single-product">
                            <a href="#" class="image d-inline-block">
                                <img src="{{ asset('assets/img/product4.jpg') }}" alt="image">
                            </a>
