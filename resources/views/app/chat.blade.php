                    ...
                    <div class="chat-menu">
                        ...
                        <ul class="list-group list-group-user list-unstyled mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user2.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user3.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                        ...
                        <ul class="list-group list-group-user list-unstyled mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user4.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user5.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user6.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                        <span class="status-online"></span>
                                    </div>
                                    <div class="user-name">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user7.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                        <span class="status-away"></span>
                                    </div>
                                    <div class="user-name">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user8.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                        <span class="status-busy"></span>
                                    </div>
                                    <div class="user-name">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user9.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                        <span class="status-offline"></span>
                                    </div>
                                    <div class="user-name">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="avatar mr-3">
                                        <img src="{{ asset('assets/img/user10.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                        <span class="status-online"></span>
                                    </div>
                                    <div class="user-name">
