    ...
    <div class="card mb-30">
        ...
        <div class="card-body">
            ...
            <div class="demo-code-preview" data-label="Code Example">
                <div class="highlight" id="basicJumbotron">
<pre>
<code class="language-html" data-lang="html">
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"jumbotron py-4"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#basicJumbotron"><i class='bx bx-copy'></i></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-30">
        ...
        <div class="card-body">
            <div class="jumbotron py-4 jumbotron-fluid">
                <div class="container">
            ...
            <div class="demo-code-preview" data-label="Code Example">
                <div class="highlight" id="fluidJumbotron"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"jumbotron py-4 jumbotron-fluid"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#fluidJumbotron"><i class='bx bx-copy'></i></button>
                </div>
            </div>
        </div>
    </div>
