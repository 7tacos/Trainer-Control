...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-dark btn-sm"</span><span class="nt">&gt;</span>Large button<span class="nt">&lt;/button&gt;</span></code></pre>
    ...
    <div class="card mb-30 button-card-box">
        ...
        <div class="card-body">
            <a href="#" class="btn btn-primary active mt-2 mr-2" role="button">Primary link</a>
            <a href="#" class="btn btn-secondary active mt-2 mr-2" role="button">Secondary Link</a>
            <a href="#" class="btn btn-success active mt-2 mr-2" role="button">Success Link</a>
            <a href="#" class="btn btn-danger active mt-2 mr-2" role="button">Danger Link</a>
            <a href="#" class="btn btn-warning active mt-2 mr-2" role="button">Warning Link</a>
            <a href="#" class="btn btn-info active mt-2 mr-2" role="button">Info Link</a>
            <a href="#" class="btn btn-light active mt-2 mr-2" role="button">Light Link</a>
            <a href="#" class="btn btn-dark active mt-2 mr-2" role="button">Dark Link</a>
            <div class="demo-code-preview" data-label="Code Example">
