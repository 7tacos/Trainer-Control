...
@section('content-wrapper')
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{ asset('assets/img/3.jpg') }}" alt="First slide">
                            </div>

                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{ asset('assets/img/4.jpg') }}" alt="First slide">
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="card bg-dark text-white mb-30 p-0">
                <img src="{{ asset('assets/img/slider/1.jpg') }}" class="card-img" alt="image">
    ...
    <div class="card-group mb-30">
        <div class="card p-0">
            <img src="{{ asset('assets/img/1.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
        ...
        <div class="card p-0">
            <img src="{{ asset('assets/img/2.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
                <h5 class="card-title font-weight-bold">Card Title</h5>
        ...
        <div class="card p-0">
            <img src="{{ asset('assets/img/3.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
                <h5 class="card-title font-weight-bold">Card Title</h5>
    ...
    <div class="card-deck mb-30">
        <div class="card p-0">
            <img src="{{ asset('assets/img/6.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
                <h5 class="card-title font-weight-bold">Card title</h5>
        ...
        <div class="card p-0">
            <img src="{{ asset('assets/img/5.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
                <h5 class="card-title font-weight-bold">Card title</h5>
                <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="card p-0">
            <img src="{{ asset('assets/img/4.jpg') }}" class="card-img-top" alt="image">
            <div class="card-body p-4">
                <h5 class="card-title font-weight-bold">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
